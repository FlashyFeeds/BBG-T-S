...
local ROW_SLOT_TYPES :table = {};
	...
	ROW_SLOT_TYPES[ROW_INDEX.IDENTITY]  = "SLOT_IDENTITY";
...
local PIC_CARD_TYPE_IDENTITY        :string = "Governments_IdentityCard"
...
local PICS_SLOT_TYPE_CARD_BGS		:table  = {
	...
	SLOT_IDENTITY       = PIC_CARD_TYPE_IDENTITY
};
...
local IMG_POLICYCARD_BY_ROWIDX :table = {};
	...
	IMG_POLICYCARD_BY_ROWIDX[ROW_INDEX.IDENTITY] = PIC_CARD_TYPE_IDENTITY;
...
function IsSlotTypeLegalInRow( nRowIndex:number, strSlotType:string )
	...
	return #m_ActivePolicyRows[nRowIndex].SlotArray > 0 and 
		...
		((m_isAllowAnythingInWildcardSlot and not (strSlotType == "SLOT_IDENTITY" or strSlotType = "SLOT_TIMEEFCT")) and nRowIndex == ROW_INDEX.WILDCARD)); --manually disable IDENTITY and TIMEEFCT in wildcard
end
