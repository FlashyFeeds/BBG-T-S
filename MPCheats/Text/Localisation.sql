...
-- English US ------------------------------------------------------------------------------------------------------------
		...
		("LOC_CHEAT_MENU_GOLD",  					"en_US",		"Adds +10000 [ICON_Gold]"),
...
-- Italian --------------------------------------------------------------------------------------------------
		...
		("LOC_CHEAT_MENU_GOLD", 					"it_IT", 		"Aggiunge +10000 [ICON_Gold]"),
...
-- Japanese ------------------------------------------------------------------------------------------------------------
		...
		("LOC_CHEAT_MENU_GOLD",  					"ja_JP",		"ゴールドを追加 +10000 [ICON_Gold]"),
		...
		("LOC_CHEAT_MENU_FAITH",  					"ja_JP",		"信仰を追加 +10000 [ICON_Faith]"),
